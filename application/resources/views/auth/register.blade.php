...
@section('content')
    <form method="POST" action="{{ route('register') }}" class="max-w-md mx-auto mt-12 space-y-6 bg-white p-6 rounded-lg shadow-sm border border-l-4 border-gray-200 hover:shadow transition">
        @csrf
        ...
        <button type="submit" class="w-full bg-blue-600 text-white px-4 py-2 rounded hover:bg-blue-700 transition cursor-pointer">{{ __('messages.register') }}</button>
